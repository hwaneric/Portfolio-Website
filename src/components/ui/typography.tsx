...
>(({ className, ...props }, ref) => (
  <h1
    ref={ref}
    className={cn(
      "scroll-m-20 text-4xl font-extrabold tracking-tight text-slate-700 lg:text-5xl",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h2
    ref={ref}
    className={cn(
      "scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight text-slate-800 transition-colors",
      className,
    )}
    {...props}
  />
...
export const TypographyHTable = React.forwardRef<
  HTMLHeadingElement,
  ComponentPropsWithoutRef<"h2">
>(({ className, ...props }, ref) => (
  <h2
    ref={ref}
    className={cn(
      "scroll-m-20 pb-2 text-3xl font-semibold tracking-tight text-slate-800 transition-colors first:mt-0",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "scroll-m-20 text-2xl font-semibold tracking-tight text-slate-800",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h4
    ref={ref}
    className={cn(
      "scroll-m-20 text-xl font-semibold tracking-tight text-slate-800",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  ...
  <p
    ref={ref}
    className={cn("leading-7 text-slate-800", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <blockquote
    ref={ref}
    className={cn("mt-6 border-l-2 pl-6 italic text-slate-800", className)}
    {...props}
  />
));
...
export function TypographyList({ items }: { items: string[] }) {
  return (
    <ul className="my-6 ml-6 list-disc text-slate-800 [&>li]:mt-2">
      {items.map((item) => (
        <li key={item}>{item}</li>
      ))}
    </ul>
...
>(({ className, ...props }, ref) => (
  <code
    ref={ref}
    className={cn(
      "relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold text-slate-800",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-xl text-muted-foreground text-slate-800", className)}
    {...props}
  />
));
...
export const PageHeader1 = React.forwardRef<
  HTMLHeadingElement,
  ComponentPropsWithoutRef<"h2">
>(({ className, ...props }, ref) => (
  <h2
...
export const PageSubHeader1 = React.forwardRef<
  HTMLParagraphElement,
  ComponentPropsWithoutRef<"p">
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-muted-foreground text-slate-800", className)}
    {...props}
  />
));
PageSubHeader1.displayName = "PageSubHeader1";

export const PageHeader2 = React.forwardRef<
  HTMLHeadingElement,
  ComponentPropsWithoutRef<"h3">
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("text-lg font-medium text-slate-800", className)}
    {...props}
  />
));
PageHeader2.displayName = "PageHeader2";

export const PageSubHeader2 = React.forwardRef<
  HTMLParagraphElement,
  ComponentPropsWithoutRef<"p">
>(({ className, ...props }, ref) => (
  <p
